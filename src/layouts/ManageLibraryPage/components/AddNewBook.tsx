...
export const AddNewBook = () => {
  ...
  const [addNewBookIsLoading, setAddNewBookIsLoading] = useState(true);
  ...
  const [selectedImg, setSelectedImage] = useState<any>(null);

  function categoryField(value: string) {
    setCategory(value);
  }

  async function base64ConversionOfImages(e: any) {
    if (e.target.files[0]) {
    ...
    <div className="container mt-5 mb-5">
      ...
      <div className="card-body">
        <form method="post">
          ...
          <input type="file" onChange={(e) => base64ConversionOfImages(e)} />
          <div>
